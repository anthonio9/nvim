...
== To install an lsp server for python, run below:
...
1. Visit https://www.nerdfonts.com/[NerdFonts] and install a proper font, perhaps **JetBrainsMono**?
2. Download and extract the font to __~/.local/share/fonts/FONTNAME__.

[source, bash]
----
unzip ~/Downloads/font.zip -d ~/.local/share/fonts/FONTNAME
----

3. Rebuild the font cache, inspect the logs to make sure that your path was included
...
4. Find the font name in the terminal emulator preferences.
